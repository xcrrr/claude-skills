...
## When NOT to Use
- Long-form editorial or thought-leadership articles (use `blog-post` skill)
- Technical documentation or product guides (use `technical-writer` skill)
- Journalistic or news content
- Academic writing (use `academic-essay` skill)
...
1. **Identify the ONE conversion goal.** Every piece of copy has one job: get a click, start a trial, complete a purchase, fill a form. Determine this before writing a word.

2. **Define the target reader.** Who are they? What do they desperately want? What pain are they trying to escape? What objections will they have? Copy that speaks to everyone persuades no one.

3. **Extract benefits from features.** For each product feature, ask "so what?" until you reach an emotional or practical outcome:
...
5. **Write the headline first.** The headline is 80% of the copy's success. Formulas:
...
6. **Use power words with intention.** Don't stuff—select 2–3 per piece:
...
7. **Write the CTA as a verb phrase, not a noun.**
   - ❌ "Submit", "Click here", "Learn more"
   - ✅ "Start my free trial", "Get my custom plan", "Save my spot", "See how it works"

8. **Create A/B variations.** Change one element at a time. Commonly tested elements:
